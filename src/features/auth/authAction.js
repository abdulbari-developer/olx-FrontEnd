...
try{
  const responce = await fetch(`${baseURL}/user/user/register`,{
    method:"POST",
    headers:{
...
try{
  const responce = await fetch(`${baseURL}/user/user/verifyOTP`,{
    method:"POST",
    headers:{
        "Content-Type": "application/json",
    },
...
try{
  const responce = await fetch(`${baseURL}/user/user/login`,{
    method:"POST",
    headers:{
        "Content-Type": "application/json",
    },
